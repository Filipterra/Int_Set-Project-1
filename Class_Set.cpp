 ...
 *
 *  Description : Implementation of a class representing sets of integers
 */
...
//Default constructor of empty set, for reasons unbeknowst to me
Set::Set ()
{
	Name=new char[20];
	strcpy(Name,"");
...
#ifdef _DEBUG
	cout<<"Empty integer set  has been added."<<endl;
#endif
}

//Creating a new empty set by user with given name
...
#ifdef _DEBUG
    cout<<"Temporary integer set has been created by a copy constructor."<<endl;
#endif
}
...
Set::Set (Set&& S)
{
    ...
    S.Elements=nullptr;
#ifdef _DEBUG
    cout<<"Temporary integer set has been created by a move constructor."<<endl;
#endif
}
...
Set::~Set()
{
    if (Name!=nullptr && Elements!=nullptr)
    {
#ifdef _DEBUG
...
//Move operator (without changing the set's name)
...
#ifndef _DEBUG
//Returning the constant name of a set for usage by non-friend functions
